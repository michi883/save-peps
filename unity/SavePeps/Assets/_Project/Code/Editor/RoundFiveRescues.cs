            ...
            rescue.Objects = new[]
            {
                new RescueObject
                {
                    ...
                    Steps = new[]
                    {
                        ...
                        Sfx(0.60f, "splash"),
                        Rotate(0.60f, 0.28f, SceneRef.Self, new Vector3(0f, 0f, -52f)),
                        Rotate(0.88f, 0.28f, SceneRef.Self, new Vector3(0f, 0f, 52f)),
                        Sfx(0.96f, "splash"),
                        Resize(0.68f, 0.65f, "Bilge", 0.12f, EaseKind.In),
                        Move(0.68f, 0.65f, StepKind.Fly, "Bilge", new Vector3(0f, -0.06f, 0f)),
                        Move(1.35f, 0.15f, StepKind.Hide, "Bilge", Vector3.zero),
                        Move(1.22f, 0.58f, StepKind.Fly, "Punt", new Vector3(0f, 0.22f, 0f),
                            ease: EaseKind.Back),
                        Haptic(1.26f, "light"),
                        Face(1.30f, SceneRef.PepA, PepFace.Hopeful),
                        Face(1.30f, SceneRef.PepB, PepFace.Hopeful),
                        Move(1.55f, 0.48f, StepKind.Hop, SceneRef.PepA,
                            new Vector3(0.52f, -0.03f, 0.82f), amplitude: 0.16f, ease: EaseKind.Hop),
                        Move(2.05f, 0.45f, StepKind.Hop, SceneRef.PepA,
            ...
            rescue.Objects = new[]
            {
                ...
                new RescueObject
                {
                    ...
                    Steps = new[]
                    {
                        ...
                        // Pep steps onto the raft
                        Move(0.66f, 0.52f, StepKind.Hop, SceneRef.PepA,
                            new Vector3(0.44f, -0.16f, 0.70f), amplitude: 0.16f, ease: EaseKind.Hop),
                        // Mooring rope unties and frees the raft
                        Move(1.15f, 0.15f, StepKind.Hide, "Mooring", Vector3.zero),
                        Sfx(1.18f, "creak"),
                        // Rhythmic rowing strokes across channel
                        Sfx(1.24f, "splash"),
                        Sfx(1.70f, "splash"),
                        Move(1.20f, 1.30f, StepKind.Shake, SceneRef.Self, Vector3.zero,
                            amplitude: 20f, ease: EaseKind.InOut),
                        Move(1.20f, 1.30f, StepKind.Fly, "Raft",
                            new Vector3(0.30f, 0f, 1.00f), ease: EaseKind.InOut),
                        Move(1.20f, 1.30f, StepKind.Fly, SceneRef.PepA,
                            new Vector3(0.30f, 0f, 1.00f), ease: EaseKind.InOut),
                        Move(1.20f, 1.30f, StepKind.Fly, SceneRef.Self,
                            new Vector3(0.30f, 0f, 1.00f), ease: EaseKind.InOut),
                        // Pep steps up onto far jetty
                        Move(2.54f, 0.42f, StepKind.Hop, SceneRef.PepA,
            ...
            rescue.Objects = new[]
            {
                ...
                new RescueObject
                {
                    ...
                    Steps = new[]
                    {
                        ...
                        Sfx(0.60f, "splash"),
                        // The tether rope swings into place attached to upstream mooring post
                        Move(0.72f, 0.18f, StepKind.Show, "Swing", Vector3.zero),
                        Sfx(0.74f, "creak"),
                        Face(0.80f, SceneRef.PepA, PepFace.Hopeful),
                        // Pep hops onto the buoy
                        Move(0.85f, 0.50f, StepKind.Hop, SceneRef.PepA,
                            new Vector3(0.28f, -0.09f, -0.30f), amplitude: 0.14f, ease: EaseKind.Hop),
                        // Powerful tidal sea current surges through channel
                        Sfx(1.35f, "splash"),
                        Haptic(1.35f, "medium"),
                        Move(1.35f, 1.10f, StepKind.Shake, "Current", Vector3.zero,
                            amplitude: 4f, ease: EaseKind.InOut),
                        // Buoy & Pep sweep in a dramatic pendulum arc across the entire waterway
                        Move(1.35f, 1.10f, StepKind.Arc, SceneRef.PepA,
                            new Vector3(0.80f, 0f, 0.50f), amplitude: 0.32f, ease: EaseKind.InOut),
                        Move(1.35f, 1.10f, StepKind.Arc, SceneRef.Self,
                            new Vector3(0.80f, 0.06f, 0.50f), amplitude: 0.32f, ease: EaseKind.InOut),
                        // Pep steps up on right pier

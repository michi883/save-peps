            ...
            rescue.Objects = new[]
            {
                new RescueObject
                {
                    ...
                    Steps = new[]
                    {
                        ...
                        Sfx(0.66f, "clank"),
                        Haptic(0.68f, "medium"),
                        // Meshed gear train engages and spins
                        Move(0.72f, 0.95f, StepKind.Spin, SceneRef.Self, Vector3.zero, amplitude: -320f,
                            ease: EaseKind.Out),
                        Move(0.72f, 0.95f, StepKind.Spin, "GearTrain", Vector3.zero, amplitude: 260f,
                            ease: EaseKind.Out),
                        Move(0.72f, 0.95f, StepKind.Spin, "UpperGears", Vector3.zero, amplitude: -360f,
                            ease: EaseKind.Out),
                        Sfx(0.76f, "ratchet"),
                        // Governor spins up at high speed and rises
                        Move(0.74f, 0.90f, StepKind.Spin, "Governor", Vector3.zero, amplitude: 720f,
                            ease: EaseKind.Out),
                        Move(0.74f, 0.90f, StepKind.Fly, "Governor", new Vector3(0f, 0.06f, 0f)),
                        // Mechanical linkage arm rocks to trip the gate latch
                        Rotate(0.78f, 0.60f, "LinkageArm", new Vector3(0f, 0f, 32f), EaseKind.InOut),
                        Sfx(1.10f, "clank"),
                        // Portcullis rises
                        Move(1.12f, 0.72f, StepKind.Fly, "Portcullis",
                            new Vector3(0f, 0.64f, 0f), ease: EaseKind.InOut),
                        Sfx(1.45f, "click"),
                        Face(1.20f, SceneRef.PepA, PepFace.Hopeful),
                        Face(1.20f, SceneRef.PepB, PepFace.Hopeful),
                        // PepB walks through the opened gate
            ...
            rescue.Objects = new[]
            {
                ...
                new RescueObject
                {
                    ...
                    Steps = new[]
                    {
                        ...
                        Rotate(0.60f, 0.30f, SceneRef.Self, new Vector3(0f, 44f, 0f)),
                        Sfx(0.64f, "click"),
                        Haptic(0.64f, "light"),
                        // Solar beam reflection and receiver ignition
                        Move(0.80f, 0.20f, StepKind.Show, "BeamBounce", Vector3.zero),
                        Sfx(0.84f, "chime"),
                        Haptic(0.84f, "light"),
                        Move(0.88f, 0.22f, StepKind.Show, "SensorGlow", Vector3.zero),
                        // The whole courtyard lights up with glowing beacons
                        Move(0.96f, 0.35f, StepKind.Show, "CourtyardLights", Vector3.zero),
                        Sfx(0.98f, "bell"),
                        // The Great Clock overhead gears awaken and rotate
                        Move(1.02f, 1.25f, StepKind.Spin, "GreatClockGears", Vector3.zero, amplitude: 260f,
                            ease: EaseKind.InOut),
                        Move(1.05f, 1.15f, StepKind.Fly, "OverheadPistons", new Vector3(0f, 0.06f, 0f),
                            ease: EaseKind.InOut),
                        Sfx(1.08f, "ratchet"),
                        Haptic(1.10f, "medium"),
                        // Iris dynamo whirls open
                        Move(1.15f, 0.70f, StepKind.Spin, "IrisGate", Vector3.zero, amplitude: 110f,
                            ease: EaseKind.InOut),
                        Resize(1.15f, 0.70f, "IrisGate", 0.14f, EaseKind.InOut),
                        // Grand clockwork drawbridge unfolds across the sunken chasm
                        Move(1.22f, 0.85f, StepKind.Fly, "ClockBridge", new Vector3(0f, 0.13f, 0f),
                            ease: EaseKind.InOut),
                        Sfx(1.95f, "clank"),
                        Haptic(1.98f, "medium"),
                        Face(1.25f, SceneRef.PepA, PepFace.Hopeful),
                        Face(1.25f, SceneRef.PepB, PepFace.Hopeful),
                        // Pep traversal across the unfolded grand clock bridge
                        Move(2.05f, 0.40f, StepKind.Hop, SceneRef.PepB,
                            new Vector3(-0.20f, 0f, -0.45f), amplitude: 0.15f, ease: EaseKind.Hop),
                        Move(2.45f, 0.40f, StepKind.Hop, SceneRef.PepB,
                            new Vector3(-0.18f, 0f, -0.40f), amplitude: 0.15f, ease: EaseKind.Hop),
                        Move(2.20f, 0.50f, StepKind.Hop, SceneRef.PepA,
                            new Vector3(0.12f, 0f, 0.20f), amplitude: 0.14f, ease: EaseKind.Hop),
                        Meet(2.85f, 0.70f),
                        Sfx(2.90f, "reunion"),
                    },
                },

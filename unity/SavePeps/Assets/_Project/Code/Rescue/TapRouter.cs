...
namespace SavePeps.Rescue
{
    ...
    public sealed class TapRouter : MonoBehaviour
    {
        ...
        ///
        /// Not test-only scaffolding: the editor preview and Rescue Gauntlet
        /// both need to play an outcome on demand, and routing them through the
        /// same entry point as a real tap is what keeps the preview honest
        /// about what the player will get.
        /// </summary>
